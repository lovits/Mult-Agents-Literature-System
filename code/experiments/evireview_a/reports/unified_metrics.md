...
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | candidate_count | 194 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | candidate_reduction_rate | 0.1134 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | deduplicated_count | 172 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | duplicate_count | 22 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | mean_reference_support | 0.3609 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | reference_partial_or_better_rate | 0.036 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | reference_unsupported_rate | 0.0 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | selected_count | 139 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | full | topk_overlap_with_full | 1.0 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | candidate_count | 194 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | candidate_reduction_rate | 0.0 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | deduplicated_count | 194 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | duplicate_count | 0 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | mean_reference_support | 0.3632 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | reference_partial_or_better_rate | 0.0355 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | reference_unsupported_rate | 0.0 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | selected_count | 141 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_dedup | topk_overlap_with_full | 0.8652 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | candidate_count | 194 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | candidate_reduction_rate | 0.1134 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | deduplicated_count | 172 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | duplicate_count | 22 | silver | graph_ablation_metrics.json |
...
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | reference_partial_or_better_rate | 0.0216 | silver | graph_ablation_metrics.json |
...
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | selected_count | 139 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_ranker | topk_overlap_with_full | 0.9353 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | candidate_count | 194 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | candidate_reduction_rate | 0.1134 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | deduplicated_count | 172 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | duplicate_count | 22 | silver | graph_ablation_metrics.json |
...
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | reference_partial_or_better_rate | 0.0288 | silver | graph_ablation_metrics.json |
...
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | selected_count | 139 | silver | graph_ablation_metrics.json |
| Local OpenReview/PRISM | ablation | agent_rag_graph | no_verifier | topk_overlap_with_full | 0.9424 | silver | graph_ablation_metrics.json |
...
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | decision_counts.Accept | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | decision_counts.Reject | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.accuracy | 0.4333 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.confusion.Accept.Accept | 3 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.confusion.Accept.Reject | 12 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.confusion.Reject.Accept | 5 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.confusion.Reject.Reject | 10 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.count | 30 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.macro_f1 | 0.4007 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Accept.f1 | 0.2609 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Accept.precision | 0.375 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Accept.recall | 0.2 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Accept.support | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Reject.f1 | 0.5405 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Reject.precision | 0.4545 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Reject.recall | 0.6667 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.per_label.Reject.support | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | evidence_risk_signal.roc_auc | 0.3978 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | existing_metadata_baseline_macro_f1 | 0.68 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.accuracy | 0.5 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.confusion.Accept.Accept | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.confusion.Accept.Reject | 0 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.confusion.Reject.Accept | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.confusion.Reject.Reject | 0 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.count | 30 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.macro_f1 | 0.3333 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Accept.f1 | 0.6667 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Accept.precision | 0.5 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Accept.recall | 1.0 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Accept.support | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Reject.f1 | 0.0 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Reject.precision | 0.0 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Reject.recall | 0.0 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.per_label.Reject.support | 15 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | majority_baseline.roc_auc | 0.5 | diagnostic | auxiliary_decision_signal_metrics.json |
| Local OpenReview/PRISM | classification | auxiliary_evidence_risk | aggregate | paper_count | 30 | diagnostic | auxiliary_decision_signal_metrics.json |
