...
2. **PeerQA-XT**: 12,628 train/validation/test scientific QA pairs with full paper text and peer-review-derived questions, CC-BY-NC-SA-4.0. A 500-row test retrieval baseline is now prepared for Paper-RAG QA without hand labels.
